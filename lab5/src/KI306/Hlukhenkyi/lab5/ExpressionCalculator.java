...
public class ExpressionCalculator {
     ...
     */
    public double calculateExpression() throws ArithmeticException, NegativeSinInputException {
        if (x < 0) {
            throw new NegativeSinInputException();
        }
    ...
    public void saveResultToFile(double result) throws IOException {
        ...
        try (DataOutputStream binaryWriter = new DataOutputStream(new FileOutputStream("result"))) {
